	...
	if($first_name == '') {
		...
		$chargify_customer_id = $chargify->createCustomer($first_name,$last_name,$email,$company_name,$city,$state,$zip,$country,$address,$phone);
                ...
                {   
                    ...
                    $sql="INSERT INTO users(firstname,lastname,email,username,country,state,city,zip,status,type,chargify_customer_id,address,epassword,salt) values ('".dbAbstract::returnRealEscapedString(stripslashes($first_name))."','".dbAbstract::returnRealEscapedString(stripslashes($last_name))."','".dbAbstract::returnRealEscapedString(stripslashes($email))."','".dbAbstract::returnRealEscapedString(stripslashes($user_name))."','".dbAbstract::returnRealEscapedString(stripslashes($country))."','".dbAbstract::returnRealEscapedString(stripslashes($state))."','".dbAbstract::returnRealEscapedString(stripslashes($city))."','$zip','1','".dbAbstract::returnRealEscapedString(stripslashes("store owner"))."','".$chargify_customer_id."','".dbAbstract::returnRealEscapedString(stripslashes($address))."', '".$ePassword."', '".$mSalt."')";
