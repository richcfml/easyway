<?php 
    ...
    if($mod == 'bhanalytics')
    {
        $admin_include_content = "admin_contents/analytics/bh_analytics.php";
    }
...
?>
    <div id="navigation">
        ...
        ?>
            ...
            <div class="links <?=$mod=='bhanalytics' ? 'selected' : ''?>"><a href="?mod=bhanalytics" class="">BH Analytics</a></div>
        <?php 
        } 
        ?> 
        <?php 
