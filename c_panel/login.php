...
<?php if(@$admin_err == 1){?><div class="msg_error">Either username or password is not correct!</div><? }?>
<?php if(@$admin_err == 2){?><div class="msg_error">Account not activated!</div><? }?>
<?php if(@$admin_err == 3){?><div class="msg_error">One or more of your restaurants may be suspended. Click <a href="<?=$chargify_url?>">here</a> to update your billing information</div><? }?>
<?php if (isset($_GET["msg"])) { if($_GET["msg"] == "chargify_update_success"){?><div class="msg_error">Your account has been successfully updated and their restaurant has been re-activated</div><? } }?>
