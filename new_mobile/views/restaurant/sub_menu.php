                                                ...
                                                <hgroup class=menu-item__info>
                                                    ...
                                                    if ($product->item_type != '') {
                                                        ...
                                                        if (strpos('x'.$product->item_type, 'B') ) {
                                                            $bhBack="../css/new_mobile/bh.png";
                                                            echo('<i class="identifier__low-fat" style=" background:url(../css/new_mobile/bh.png)"  ></i>');
                                                        }
                                                    }
                                                    ?>
                                                </hgroup>
        ...
        function setProductDetailsToPopup(productDetails) {
            ...
            if (productDetails.item_type) {
                ...
                if (product_item_type.indexOf('B') !== -1) {
                   $('.active_form  #retail_price').after('<i class="identifier__low-fat" style=" background:url(../css/new_mobile/bh.png)"  ></i>' )
                }
                }
            }
