    ...
    <div class=notification__overlay></div>
        <header class=header style="background-image:url(<?php echo $objRestaurant->header_image; ?>);">
         ...
         <div class=header__store-info-container itemscope='' itemtype='http://schema.org/LocalBusiness'>
            <h1 class=header__store-name itemprop=name>Sushi Kushi</h1>
            <span class=header__store-description itemprop=description>The best sushi in town.</span> 
            <p class=header__store-info itemprop=address itemtype='http://schema.org/PostalAddress' tiemscope=''> <b><?php if($objRestaurant->isOpenHour){ echo 'Open</b>'; }else{echo 'Close</b>';} ?></b> <br> <span itemprop=streetAddress><?= $objRestaurant->rest_address ?></span>, <span itemprop=addressLocality><?= $objRestaurant->rest_city ?></span>, <abbr itemprop=addressRegion title='<?php echo $objRestaurant->rest_state ?>'><?php echo $objRestaurant->rest_state ?></abbr> </p>
            <a class=header__store-phone href='tel: <?= $objRestaurant->phone ?>' title=store-phone> <span itemprop=telephone><?= $objRestaurant->phone ?></span> </a> 
         </div>
      </header>
