...
if (isset($_SESSION['admin_session_user_name'])) {
    ...
    $restaurant_query = dbAbstract::Execute("SELECT id,chargify_subscription_id from resturants where chargify_subscription_id = '" . $sso_token . "'");
    ...
    if ($restaurant_info['id'] == $_SESSION['ResturantId']) {
        ...
        dbAbstract::Insert("INSERT INTO vendasta_validation set sso_token = '" . $sso_token . "'
