...
class cart
{
                ...
                if($cartProduct->prd_id == $product_key){
                    ...
                    if($bh_flag){
                        if($cartProduct->quantity > 1){
                            //$sub_price = (($cartProduct->sale_price * ($cartProduct->quantity - 1)) + (($cartProduct->sale_price * ($cartProduct->quantity - ($cartProduct->quantity - 1)))/2)); //use to discount 50%, commented now since discount is 100% shown below
                                        
                            $sub_price = (($cartProduct->sale_price * ($cartProduct->quantity - 1)));
                        }else{
                            ...
                            var_dump($keys);
                                    ...
                                    //$sub_price = (($cartProduct->sale_price * $cartProduct->quantity)-($cartProduct->sale_price * $cartProduct->quantity));//use to discount 50%, commented now since discount is 100% shown below
                                ...
                                $sub_price = (($cartProduct->sale_price * $cartProduct->quantity)-($cartProduct->sale_price * $cartProduct->quantity));
                            }
                        }
    ...
    #echo '<pre>Subtotal: ' . $this->sub_total . ' <br/>Sales Tax:  ' . $this->sales_tax() . '<br/> Discount:  ' . $this->bh_discount .  ' <br/> Total: ' . $this->grand_total() . '</pre>';
        if($debug) 
        {
