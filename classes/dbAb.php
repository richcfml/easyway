...
class dbAb
{
    public function Execute($pSQL, $pC_Panel = 0, $pLogResults = false)
    {
        global $dbh;
        if ($pC_Panel==0)
        {
    ...
    public function ExecuteArray($pSQL, $pC_Panel = 0, $pLogResults = false)
    {
        global $dbh;
        if ($pC_Panel==0)
        {
    ...
    public function ExecuteObject($pSQL, $pC_Panel = 0, $pClassName = "", $pLogResults = false)
    {
        global $dbh;
        if ($pC_Panel==0)
        {
    ...
    public function ExecuteAssoc($pSQL, $pC_Panel = 0, $pLogResults = false)
    {
        global $dbh;
        if ($pC_Panel==0)
        {
    ...
    public function Update($pSQL, $pC_Panel = 0, $pReturnType = 0, $pLogResults = false)
    {
        global $dbh;
		$mResult = $dbh->prepare($pSQL);
    ...
    public function Insert($pSQL, $pC_Panel = 0, $pReturnType = 0, $pLogResults = false)
    {
        global $dbh;
        $mResult = $dbh->prepare($pSQL);
        if($mResult->execute())
    ...
    public function Delete($pSQL, $pC_Panel = 0, $pReturnType = 0, $pLogResults = false)
    {
         global $dbh;
		$mResult = $dbh->prepare($pSQL);
		$mResult->execute();
    ...
    public function returnObject($pResult, $pC_Panel = 0, $pClassName = "", $pLogResults = false) //$pResult is result(object) of mysqli_query
    {
        if ($pResult)
        {
            if ($pClassName=="")
    ...
    public function returnRow($pResult, $pC_Panel = 0, $pLogResults = false) //$pResult is result(object) of mysqli_query
    {
        $mRow = $pResult->fetch();
        if ($pLogResults)
        {
    ...
    public function returnArray($pResult, $pC_Panel = 0, $pLogResults = false) //$pResult is result(object) of mysqli_query
    {
    ...
    public function returnAssoc($pResult, $pC_Panel = 0, $pLogResults = false) //$pResult is result(object) of mysqli_query
    {
    ...
    public function returnRowsCount($pResult, $pC_Panel = 0, $pLogResults = false) //$pResult is result(object) of mysqli_query
    {
        if ($pResult)
        {
    ...
    public function returnResult($pResult, $pRowNum, $pField, $pC_Panel = 0, $pLogResults = false) //$pResult is result(object) of mysqli_query
    {
    ...
    public function returnRealEscapedString($pString, $pC_Panel = 0, $pLogResults = false)
    {
        global $dbh;
        /*
