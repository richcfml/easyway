...
<div id="BodyLeftArea" style="width:750px;">
		...
		<div style="clear: both;"></div>
		<form action="?item=product&kiosk=1&id=<? echo $product->prd_id?>&ajax=1" method="post" id="frmPrd" name="frmPrd">
		<?php
			$attribute_index=0;
		   	$attribute_name="attr";
				...
				<script type="text/javascript" language="javascript">
					$(document).ready(function($)
					{
						$("#addtocart").click(function()
						{
							...
							mUrl="<?=$SiteUrl?><?=$objRestaurant->url?>/?item=favindex&kiosk=1&addtocart=1&ProductID=<?=$_GET['id']?>&rndm="+mRandom+"&ajax=1";
							$.ajax
							({
								url: mUrl,
								type:'POST',
