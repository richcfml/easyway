<!DOCTYPE html>
<html dir="ltr" lang="en-US"> <!-- Its </html> is in kiosk/index.php #HeaderHTML -->
<head>
    <meta charset="utf-8">
...
<body> <!-- Its </body> is in kiosk/index.php #HeaderBody -->
...
<div id="maincontainer"> <!-- Its </div> is in kiosk/index.php #HeaderDiv -->
<?php 
if(empty($_SESSION["restaurant_deisgn_settings_id"])) 
{ 
?>
	<div id="header" style="background:url(<?php echo $objRestaurant->header_image?>)"></div>
<?php 
} 
include $site_root_path. "views/restaurant/home_nav.php" 
?>