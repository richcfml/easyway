...
if(isset($_POST) && !empty($_POST)){
  ...
  $servername = "104.239.145.91";
  $username = "easywayordering";
  $password = "3a5yw4y0rd3ring";
  $dbname = "easywayordering";
  ...
  if ($result->num_rows > 0) {
      ...
      echo "0 results <br/>"; //in the event that there are no results echo it out to the page
     echo "<a href=\"https://easywayordering.com/bh_report/index.php\">return to form</a>";
	exit;
  }
  //Close the file
  fclose($fp);
