<?php
	...
	if (isset($_GET["orderid"]))
	{
		...
		dbAbstract::Update("UPDATE ordertbl SET PhaxioCallBack=1 WHERE OrderID=".$_GET["orderid"]);
		...
		dbAbstract::Update("UPDATE ordertbl SET PhoneCallCount=1 WHERE OrderID=".$_GET["orderid"]);
