...
$ordersCountFor31To60Days = mysql_query("SELECT cat_id, count( * ) as order_count
FROM ordertbl
...
while ($attr = mysql_fetch_array($ordersCountFor1To30Days)) {
...
while ($attr = mysql_fetch_array($ordersCountFor31To60Days)) {
...
$otherRestaurantIds = mysql_query("UPDATE resturants set orders_last_month_count = 0, orders_last_but_second_month_count = 0 Where id NOT in ($implodeArray)");
