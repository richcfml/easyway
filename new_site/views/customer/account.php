...
?>
<div id="body_left_col" style="width:668px; border:#e4e4e4 1px solid;">
      ...
      <div class="account_detail"> <strong>Email:</strong>&nbsp;&nbsp;
        ...
        &nbsp;[&nbsp;<a  href="?item=editaccount">Change</a>&nbsp;]<br />
        <br />
        <span style="color:#000; font-weight:bold;" >Main Contact Information </span> [&nbsp;<a href="?item=editaccount" class="RedText_Underline">edit</a>&nbsp;]<br />
...
?>
        ...
        <br />
        <br />
        <strong>Alternate Delivery Address:</strong> [&nbsp;<a href="?item=editaccount" class="RedText_Underline">edit</a>&nbsp;]<br />
        ...
        <br>
        <form action="?item=checkout" method="post" name="form1">
    ...
    <div id="body_right_col" style="width:300px; border:#e4e4e4 1px solid;">
	...
	$i=0;
		...
		?>
          <tr style="background-color:<?=$colour?>">
            <td align="left" valign="middle"><a href="?mod=<?=$mod?>&item=orderhistory&Orderid=<?=$orderid?>" class="RedText_Underline">
              <?=$userOrderRs->OrderID?>
              </a></td>
