...
<?php
	...
	{
		 redirect($SiteUrl .$objRestaurant1->url ."/?item=login");
		 exit;
	}
		...
		<td>
			<div style="width: 25%;">
				<div style="float: left;">
					<form id="myForm" name="myForm" method="post" action="?item=orderhistory&Orderid=<?=$mOrderID?>">
				...
				<div style="display: none; border-radius:7px;">
					...
					<form id="myForm1" name="myForm1" method="post" action="?item=orderhistory&Orderid=<?=$mOrderID?>">
