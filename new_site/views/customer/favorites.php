	...
	<div style="margin: 5px;">
		<div style="vertical-align: top; text-align: left;">
			...
			else
			{
				...
				{
					$mHrefStart = "<a style='text-decoration: none;' href='?item=addtofavorite&ajax=1'  rel='facebox'>";
					$mHrefEnd = "</a>";
		...
		?>
				<tr>
					...
					<td align="left" valign="middle" width="7%">
						<a class="removefavoritesorder"  href="<?=$SiteUrl?><?= $objRestaurant->url ."/"?>?item=cart&removefavoritesindex=<?=$favoritesindex?>" title="Remove from favorites"><img src="../images/Trashbin.png"></a>
					</td>
				</tr>
				<tr>
					<td colspan="4">
			...
			<tr>
				<td>
					...
					{			  
						...
						{ 
					?>
						<a rel="facebox" href="?mod=resturants&item=reordercm&ajax=1" style="color:#36C; font-size: 12px; text-decoration: none;">EDIT QUICK FAVORITE PREFERENCES</a>
					<?php
						}
					}
					?>
