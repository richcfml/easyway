 <form id="checkoutform" name="checkoutform" action="<?php echo $SiteUrl.$objRestaurant->url; ?>/?item=confirmpayments&session_id=<?= session_id() ?>" method="post">
    <? include "views/cart_products.php" ?> 
    <div id="second_body">
    ...
    <? include "views/paymentmethods.php" ?>
