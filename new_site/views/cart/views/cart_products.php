    ...
    <div class="qtys color_black">
        ...
        if(isset($is_rest_bh_new_promo) && $is_rest_bh_new_promo->bh_new_promotion == 1){
                if($prod->prd_id == $product_key){
                        if($prod->quantity > 1){
                                    //$test_pricing = ($prod->sale_price * ($prod->quantity - 1)) + (($prod->sale_price * ($prod->quantity - ($prod->quantity - 1)))); //use to show 50% discount. Commented for 100% discound now shown below
                                        ...
                                        if($count > 1){
                                            $n_arr = array();
                                                ...
                                                if(number_format($prod->sale_price * $prod->quantity,2) == $mx){
                                                    //$my_new_price = ($prod->sale_price * $prod->quantity);//use to show 50% discount. Commented for 100% discound now shown below
                                                ...
                                                //$my_new_price = ($prod->sale_price * $prod->quantity);//use to show 50% discount. Commented for 100% discount now shown below
                                                $my_new_price = ($prod->sale_price * $prod->quantity) - ($prod->sale_price * $prod->quantity);
                                                echo $currency . number_format($prod->sale_price * $prod->quantity,2);
    ...
    <div class="eachs color_black">
        <?
                if(isset($is_rest_bh_new_promo) && $is_rest_bh_new_promo->bh_new_promotion == 1){
                        if($prod->prd_id == $product_key){
                if($prod->quantity > 1){
                                        //$test_pricing = ($prod->sale_price * ($prod->quantity - 1)) + (($prod->sale_price * ($prod->quantity - ($prod->quantity - 1)))); //use to show 50% discount. Commented for 100% discount now shown below
                                    $test_pricing = ($prod->sale_price * ($prod->quantity - 1));
  ...
  <?
    if(isset($is_rest_bh_new_promo) && $is_rest_bh_new_promo->bh_new_promotion == 1){
        ...
        if(($prod->prd_id == $product_key) || $bh_flag){
            ...
            if($prod->quantity > 1){
                                $my_new_price = (($prod->sale_price * ($prod->quantity - ($prod->quantity - 1))));
                        }else{
