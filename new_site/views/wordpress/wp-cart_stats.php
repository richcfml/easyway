...
<div id="counting_right_col">
  <ul>
    ...
    <li><?=$currency?><?= $cart->sales_tax()?></li>
 	<li><b><?=$currency?><?= number_format($cart->grand_total(),2)?></b></li>
...
<div id="bttn">
  <input type="button" value="Edit Order" onclick="javascript:window.location='?item=detail&wp_api=load_resturant'">
</div>
<?
