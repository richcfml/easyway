...
<div class="tip_section" id="tip_section">
	...
	<ul style="list-style: none;">
		<ol>
			<li>
				<div class="tiptext"> 
					<input type="radio" name="rbd_tip"  value="1" class="rdbclass"/>Please add 20% (<?=$currency.number_format((20/100)*$cart->grand_total(),2)?>)
				</div>
			</li>
			<li>
				<div class="tiptext"><input type="radio" name="rbd_tip"  value="2" class="rdbclass"/>
					Enter my own Amount:
					<input type="text" id="delivery_tip" value="<?=$currency?>0" size="4" maxlength="4" name="delivery_tip" class="valid" style="margin-left: 21px;">
					<input type="button" name="btn_delivery_tip" id="btn_delivery_tip" value="Add gratuity">
				</div>
			</li>
			<li>
