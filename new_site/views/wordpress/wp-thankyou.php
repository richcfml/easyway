...
?>
	<style type="text/css">
		#ContentImages{ width:926px; /*border:#999 solid 1px;*/ /*padding:50px*/;}
	...
	<div id="thank_you_area" style="padding:5px; float:none; width: 926px;">
	...
	?>
		<span style="margin-top: 15px;">
			...
			<a href="<?=$SiteUrl. $objRestaurant->url ?>/?wp_api=load_resturant"><strong>Go to Home Page</strong></a> <br />
			<br />
			<br />
		</span>	
	<?php
	...
	?>
		<span style="margin-top: 15px;">
			...
			<a href="<?=$SiteUrl. $objRestaurant->url ?>/?wp_api=load_resturant"><strong>Go to Home Page</strong></a> 
			<br />
			<br />
		</span>
