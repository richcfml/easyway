  ...
  <? if(is_numeric($loggedinuser->id)) {?>
        ...
        <div class="second_body_text">
    	 ...
    	 Delivery Address:    <?= $loggedinuser->get_delivery_address(0)?><br/>
          ...
          <a href="?item=account&chooseaddress=1&wp_api=account">Select another address from account</a> </div>
        <br />
        <? }?>
        <? }else {  ?>
       ...
       <? if ($cart->delivery_type==cart::Delivery){?>
          ...
          <tr>
            ...
            <td>Phone</td>
            <td><input type="text" name="customer_phone" id="customer_phone" value="" maxlength="22"/></td>
          </tr>
