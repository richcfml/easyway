...
?>
                                            ...
                                            <div style="font-size:12px; font-weight:bold; text-align: left;">
                                                <form method="post" id="favoritesform"  action="">
                                                    ...
                                                    <div style="width: 430px; padding:10px;font-weight:normal;font-size:12px; display:none;"  class="dvLM" id="dvLM" name="dvLM">
                                                        Quick Favorite lets you order your favorite	meal simply by sending a text message!<br /><br />
    ...
    {
        if ((trim($_SESSION["EcommerceID"])!="") && (is_numeric(trim($_SESSION["EcommerceID"]))))
        {
            dbAbstract::Update("UPDATE bh_ecommerce SET OrderPlaced = 1 WHERE ID = ".$_SESSION["EcommerceID"]);
        }
    }
    $cart->destroysession();
}
