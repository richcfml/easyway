...
<form action="" method="post" class="commentsblock">
  ...
  <? } ?>
  <? if ($result===true){?>
  <div class="success">Your account password has been sent to your email address.&nbsp;&nbsp;<a href="<?=$SiteUrl . $objRestaurant->url ."/?ifrm=load_resturant"?>">Back to Home</a></font></div>
  <?  } ?>
