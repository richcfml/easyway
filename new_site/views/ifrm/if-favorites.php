	...
	<div style="margin: 5px;">
		<div style="vertical-align: top; text-align: left;">
			...
			else
			{
				...
				{
					$mHrefStart = "<a style='text-decoration: none;' href='?item=addtofavorite&ajax=1&ifrm=addtofavorite'  rel='facebox'>";
					$mHrefEnd = "</a>";
		...
		?>
				<tr>
					<td align="left" valign="middle" width="29%">
						<a rel="facebox" href="<?=$SiteUrl?><?=$objRestaurant->url?>/?item=favdetail&ifrm=favdetail&ajax=1&favoriteindex=<?=$mCount?>" class="favTitle"><?= $favorite->title ?></a>
					</td>
					<td align="left" valign="middle" width="12%">
						<span class="favPrice"><?= $currency.$mTotal ?></span>
					</td>
					<td align="center" valign="middle" width="52%">
						<a rel="facebox" href="<?=$SiteUrl?><?=$objRestaurant->url?>/?item=favdetail&ifrm=favdetail&ajax=1&favoriteindex=<?=$mCount?>" class="favTitle">view order / reorder</a>
					</td>
					<td align="left" valign="middle" width="7%">
						<a class="removefavoritesorder"  href="<?=$SiteUrl?><?= $objRestaurant->url ."/"?>?item=cart&ifrm=cart&removefavoritesindex=<?=$favoritesindex?>" title="Remove from favorites"><img src="../images/Trashbin.png"></a>
					</td>
				</tr>
				<tr>
					<td colspan="4">
			...
			<tr>
				<td>
					...
					{			  
						...
						{ 
					?>
						<a rel="facebox" href="?mod=resturants&ifrm=resturants&item=reordercm&ajax=1" style="color:#36C; font-size: 12px; text-decoration: none;">EDIT QUICK FAVORITE PREFERENCES</a>
					<?php
						}
					}
					?>
