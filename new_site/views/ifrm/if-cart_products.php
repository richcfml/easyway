...
<div style="font-size:14px; font-weight:bold; margin:3px 0px 0px 174px;"> <a href="?item=menu&ifrm=load_resturant" style="text-decoration:none; color:#CC0000;">Change to
  <?= $cart->delivery_type==cart::Delivery ?"pickup" :"delivery" ?>
  </a></div>
<div style=" clear:both"></div>
<div class="top_headings">
  <div class="item font_14px" style="width: 150px !important;">Item</div>
  <div class="des font_14px" style="width: 380px !important;">Description</div>
...
$index=-1;
  ...
  <div id="description_area" >
    <div class="items color_black" style="width: 150px !important;">
      <?=  stripslashes(stripcslashes($prod->item_title)) ?>
    </div>
    <div class="description color_black" style="width: 380px !important;"> <strong>Special Instructions</strong>:
  ...
  <div style="float:left; width:500px; padding:10px; ">
    <div style="float:right;"> <strong>Enter coupon code</strong>&nbsp;&nbsp;<br />
      <input type="button" name="btncoupon" id="btncoupon" value="Redeem"  />
      &nbsp;&nbsp;
      <input name="coupon_code" id="coupon_code" value="" size="3" />
    </div>
    
    <div style=" float:left;"><strong>For your convenience, you can add gratuity here</strong>&nbsp;<br />
