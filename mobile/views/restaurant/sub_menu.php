  <?  if ($mod=='resturants' ) { if($menuid>0){ ?>
	...
	$categoryid = (isset($_GET['category']) ? $_GET['category']:"");
					...
					?>
					<li>
						<a class="submenu <?php echo $class; ?>" category_id=<?php echo $category->cat_id; ?> href="<?=$SiteUrl?><?= $objRestaurant->url ."/"?>?menuid=<?=$menuid; ?>&category=<?php echo $category->cat_id; ?>">
