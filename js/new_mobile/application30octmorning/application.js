...
!function (e, t) {
    ...
    window.EasyWay || (window.EasyWay = {}), EasyWay.Cart = function () {
        ...
        return e.$cartTag = $("aside.cart"), e.$cartItemTag = e.$cartTag.find(".cart-item:first"), e.$cartTotalTag = e.$cartTag.find(".cart__total"), e.$cartItemListTag = e.$cartTag.find(".cart-item__list"), e.$cartEmpty = e.$cartTag.find(".cart-empty"), e.setup = function () {
            ...
            return this.fillCart(), this.$cartItemListTag.append('')
    ...
    window.EasyWay || (window.EasyWay = {}), EasyWay.Menu = function () {
        ...
        return e.$menuTag = $(".main__container > .menu"), e.$menuItemTag = $(".menu-item"), e.$quantity = $(".menu-item__quantity"), e.$footerTag = $(".footer"), e.bindEvents = function () {
            return this.$menuTag.on("click", ".menu__header", function (e) {
                ...
                return function (t) {
                    return e.activeForm = $(t.currentTarget).next(".menu-item__form"),e.appendItems(),  e.closeAllForms(), e.activeForm.toggleClass("open"), e.createStepper()
                }
        ...
        }, e.appendItems = function () {
            e.activeForm.find('fieldset').remove()
            var prdId=e.activeForm.attr('prd_id')
            var hasassociates=e.activeForm.attr('hasassociates')
            var hasattributes=e.activeForm.attr('hasattributes')
            var items= showPopup(prdId, hasassociates,hasattributes,-1,'')
    ...
    window.EasyWay || (window.EasyWay = {}), EasyWay.Notification = function () {
        ...
        return e.$overlay = $("<div>", {"class": "notification__overlay"}), e.open = function () {
            ...
            return $("head").after(this.$overlay), this.$overlay.show()
    ...
    window.EasyWay || (window.EasyWay = {}), EasyWay.Stepper = function () {
        ...
        return e.sliderOptions = {slideSelector: ".js-slide", infiniteLoop: !1, controls: !1, pagerSelector: ".footer__stepper", oneToOneTouch: !1, slideMargin: 20, buildPager: function () {
            ...
            var e;
            return $(".open, .active").removeClass("open active"), this.destroy(),this.addtocart(), e = $("<span>", {text:$('.cart__total2').text() }), $(".footer__stepper").html(e), this.updateNextAction("Place order", "js-submit", !1), EasyWay.Cart.addItem(), EasyWay.Cart.open()
        }, e
    }()
}.call(this), function () {
    window.EasyWay || (window.EasyWay = {}), EasyWay.ThemeSelector = function () {
        ...
        return e.$styleTag = $("head > #theme"), e.appendSelector = function (e) {
            var t, n, i, r;
            for (this.themes = e, this.$select = $("<select>", {id:"theme-select", style:"position: fixed; top: 5px; left: 5px;z-index:1;"}), i = Object.keys(this.themes), t = 0, n = i.length; n > t; t++)
    ...
    $(function () {
        return EasyWay.ThemeSelector.appendSelector({"default": "application.css", redish: "themes/redish.css"}), EasyWay.Header.bindEvents(),  EasyWay.Cart.setup(), EasyWay.MainMenu.setup(), EasyWay.Notification.open(), EasyWay.Sign.setup()
    })
}.call(this);