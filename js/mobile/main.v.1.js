...
$(document).ready(function() {
	...
	var slider=	$('div.cycle-slideshow');
...
function menu_down() {
	...
	/*$('.menu_list_wrapper').css({
	 ...
	 var containerHeight1 = parseInt($('.menu_list_wrapper').css('height').split('px')[0]);
	 	console.log($('.menu_list_wrapper'));
	 	 console.log($('.menu_list_wrapper').height());
		  $('.footer_wrapper').css({
			top: (containerHeight1 + 1) + 'px'
		});
		console.log(containerHeight1);*/
}
